...
public interface ExamrecordDao extends BaseMapper<ExamrecordEntity> {
	 ...
	 * 查询医生的患者的答题记录
	 */
	List<ExamrecordView> selectDoctorPatientRecords(Pagination page, @Param("doctorId") Long doctorId, 
		@Param("username") String username, @Param("papername") String papername);
}

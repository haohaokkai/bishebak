...
public class ExamrecordController {
    ...
    public R doctorList(@RequestParam Map<String, Object> params, HttpServletRequest request) {
        // 获取当前登录医生的ID
        Object userId = request.getSession().getAttribute("userId");
        if (userId == null) {
            return R.error("未登录");
        }
        Long doctorId = Long.parseLong(userId.toString());
        
        PageUtils page = examrecordService.queryDoctorPatientRecords(params, doctorId);

...
var indexNav = [
    ...
    {
        name: '咨询记录',
        url: './pages/zixunxinxi/list.html'
    },
    {
        name: '诊断记录',
        url: './pages/zhenduanjilu/list.html'
    },
    {
        name: '预约记录',
        url: './pages/yuyuejilu/list.html'
    },
]
...
var menu = [{
    "backMenu": [{
        ...
        }, {"appFrontIcon": "cuIcon-brand", "buttons": ["查看", "删除"], "menu": "错题本", "tableName": "examfailrecord"}],
        "menu": "考试管理"
    }, {
        "child": [{
            "appFrontIcon": "cuIcon-camera",

  ...
  .index-aside {
    ...
    .index-aside .index-aside-inner.menulist {
      ...
      .menulist-item {
        ...
        box-shadow: 0 0 6px rgba(30, 144, 255, .1);
        box-sizing: border-box;
      }
        ...
        & ::v-deep .el-menu.el-menu--inline {
          ...
          .el-menu-item {
            ...
            &:hover {
              ...
              padding: 0 !important;
              margin: 0;
              color: rgba(138, 174, 220, 0.8) !important;
              font-size: 14px;
              border-radius: 0;
              border-width: 0;
              border-style: solid;

<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户姓名" prop="yonghuxingming">
          <el-input v-model="ruleForm.yonghuxingming" 
              placeholder="用户" clearable  :readonly="ro.yonghuxingming"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item v-if="type!='info'"  label="诊断内容" prop="zhenduanneirong">
          <editor 
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhenduanneirong" label="诊断内容" prop="zhenduanneirong">
              <span v-html="ruleForm.zhenduanneirong"></span>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="诊断时间" prop="zhenduanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhenduanshijian" 
                type="datetime"
                :readonly="ro.zhenduanshijian"
                placeholder="诊断时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhenduanshijian" label="诊断时间" prop="zhenduanshijian">
              <el-input v-model="ruleForm.zhenduanshijian" 
                placeholder="诊断时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
	...
	if(this.ruleForm.zhenduanneirong!=null) {
		this.ruleForm.zhenduanneirong = this.ruleForm.zhenduanneirong.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    zhenduanneirongUploadChange(fileUrls) {
	this.ruleForm.zhenduanneirong = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{

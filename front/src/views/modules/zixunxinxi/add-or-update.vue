<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生职位" prop="yishengzhiwei">
          <el-input v-model="ruleForm.yishengzhiwei" 
              placeholder="医生职位" clearable  :readonly="ro.yishengzhiwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生职位" prop="yishengzhiwei">
              <el-input v-model="ruleForm.yishengzhiwei" 
                placeholder="医生职位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="资询内容" prop="zixunneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zixunneirong" label="资询内容" prop="zixunneirong">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yishengxingming = true;
          ...
          if(o=='yishengzhiwei'){
            this.ruleForm.yishengzhiwei = obj[o];
	    this.ro.yishengzhiwei = true;
            continue;
          }
          if(o=='zixunneirong'){
	...
	this.ruleForm.zixunneirong = this.ruleForm.zixunneirong.replace(reg,'../../../springboot212h6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
